...
| Key | Value |
|---|---|
| Evaluated At | 2026-07-08T06:22:51.313315Z |
...
2. **agent**: DeepSeek Agent Eval: decision_accuracy=1.000, risk_accuracy=1.000, unsafe_auto_fix_rate=0.000, hard_constraint_violation_rate=0.000
